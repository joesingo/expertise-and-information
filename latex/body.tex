...
\begin{figure}
    ...
    \caption{
        ...
        formalises \cref{ex_economist_motivation}.
    }
...
\footnotetext{
    ...
    open sets as \emph{evidence}~\citep[pp. 24]{ozgun_evidence}.
}
...
\begin{proof}
      For brevity we show \refitem{item_xsigma_mem} only, deferring the rest to
      the appendix.
      %
...
The proof of \cref{thm_mintcompl_axiomatisation} is similar to that of
...
$\Kshared_J\phi \equiv \bigland_{j \in J}\K_j\phi$.
    ...
    \footnotetext{In \citet{fagin2003reasoning}, shared knowledge is denoted
...
\begin{lemma}[\citet{fagin2003reasoning}, Lemma 2.2.1]
...
% is truthfully announced \citep{baltag2008qualitative}.
...
% In logics of public announcement \citep{plaza2007logics,van_Ditmarsch_2008},
...
%
First, our approach allows one to reason about soundness of information only if
the extent of a source's expertise is known up-front. In practical situations
it is more likely that one has to \emph{estimate} a source's expertise, e.g. on
the basis of previous reports
\citep{hunter_building_2021,dastani2004inferring}. A first attempt in this
direction has been proposed in \cite{singleton_booth_22}.

...
area $Y$, then together $A$ and $B$ will have expertise on $Y$. \todo{Possibly
rework this example: reviewer did not like it.}
...
\todo{Introduction ``could do a better job at motivating the paper''. But how?}
